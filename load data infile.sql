...
LOAD DATA INFILE "C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/202407-divvy-tripdata.csv"
INTO TABLE data202407
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES;
